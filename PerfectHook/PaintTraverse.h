...
void __fastcall hkPaintTraverse(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
		...
		{
			g_Render->Text(7, 7, Color(0, 75, 255, 255), g_Render->font.Time, ("T4ctical-Cheatz "));
			g_Render->Text(150, 7, Color(255, 255, 255, 255), g_Render->font.Time, ("Private"));
			g_Render->Text(7, 28, Color(255, 215, 0, 255), g_Render->font.Time, ("Hello Fed0r and Coore."));
		}
