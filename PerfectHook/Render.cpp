...
void Render::SetupFonts()
{
	...
	g_Surface->SetFontGlyphSet(font.ESP, "Tahoma", 15, 700, 0, 0, FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.Defuse, "Tahoma", 15, 700, 0, 0, FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.Guns, "Tahoma", 11, 700, 0, 0, FONTFLAG_DROPSHADOW);
	g_Surface->SetFontGlyphSet(font.Time, "Courier New", 17, 700, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	g_Surface->SetFontGlyphSet(font.DroppedGuns, "Tahoma", 15, 700, 0, 0, FONTFLAG_OUTLINE);
